...
- Summarization
- Tool Correctness
- JSON Correctness (Work in Progress)
- Custom Scorers
- Classifier Scorers

`Tip`: 

We're always building new scorers to add to `judgeval`. If you have a specific scorer in mind, please let us know! TODO add a contact link here
